...
interface UserCardProps {
	...
	revokeSession: (data: { token: string }) => Promise<any>;
	passkeyActions: {
	...
	twoFactorActions: {
		enable: (data: { password: string }) => Promise<any>;
		disable: (data: { password: string }) => Promise<any>;
	};
}
		...
		<Card className="w-full">
			...
			<CardContent className="grid gap-8 grid-cols-1">
				...
				<div className="flex items-center justify-between">
					...
					<div>
						<TwoFactorDialog
							enabled={currentSession?.user.twoFactorEnabled}
		...
		<Dialog onOpenChange={setIsOpen} open={isOpen}>
			...
			<DialogContent>
				...
				<div className="grid gap-2">
					<TextFieldRoot>
						<TextFieldLabel htmlFor="full-name">Full Name</TextFieldLabel>
						<TextField
	...
	return (
		<Dialog>
			...
			<DialogContent>
				...
				<div className="grid gap-2">
					<TextFieldRoot>
						<TextFieldLabel htmlFor="passkey-name">
	...
	return (
		<Dialog onOpenChange={setIsOpen} open={isOpen}>
			...
			<DialogContent>
				...
				<div className="grid gap-2">
					<TextFieldRoot>
						<TextFieldLabel htmlFor="password">Password</TextFieldLabel>
						<TextField
							type="password"
					...
					<Button
						onClick={async () => {
							...
							try {
								...
								alert(error.message || "Failed to update 2FA");
							} finally {
								setIsLoading(false);
							}
						}}
